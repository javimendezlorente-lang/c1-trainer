...
- `src/features/part1/` owns only ephemeral React state. There is no localStorage, IndexedDB, attempt repository, Error Bank, adaptive selection, or FSRS integration in this milestone.
